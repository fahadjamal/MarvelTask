...
extension UICollectionView {
     ...
     */
    func dequeueCell<T: UICollectionViewCell>(withType type: UICollectionViewCell.Type,
...
public extension UITableView {
    ...
    func registerCell(type: UITableViewCell.Type,
        ...
        register(UINib(nibName: cellId, bundle: nil),
                 forCellReuseIdentifier: identifier ?? cellId)
    }
    /**
    ...
    func dequeueCell<T: UITableViewCell>(withType type: UITableViewCell.Type,
                                         for indexPath: IndexPath) -> T? {
        return dequeueReusableCell(withIdentifier: type.identifier,
                                   for: indexPath) as? T
    }
}
