...
extension UIView {
    func customActivityIndicator(view: UIView,
                                 widthView: CGFloat? = nil,
                                 backgroundColor: UIColor? = nil,
                                 message: String? = nil,
                                 colorMessage: UIColor? = nil ) -> UIView {
        // Config UIView
...
//        self.frame = CGRect(x: selfFrameX, y: selfFrameY, width: selfWidth , height: selfHeigh)
        ...
        self.frame = CGRect(x: screenSize.origin.x,
                            y: screenSize.origin.y,
                            width: screenSizeWidth,
                            height: screenSizeHeight)
        // spinnerViewFrame
        spinnerView.frame = CGRect(x: selfFrameX,
                                   y: selfFrameY,
                                   width: selfWidth,
                                   height: selfHeigh)
        spinnerView.backgroundColor = UIColor.clear
        // ImageFrame
        loopImages.frame = CGRect(x: imageFrameX,
                                  y: imageFrameY,
                                  width: imageWidth,
                                  height: imageHeight)
        return self
